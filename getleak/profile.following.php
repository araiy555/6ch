...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <?php
            $id = $member['id'];
            $topic1 = "SELECT * FROM following WHERE user_id ='$id'";
            ...
            while ($topic = mysql_fetch_assoc($topic2)):
                ...
                $following_id = $topic['following_id'];
                $following_posts = "SELECT * FROM posts WHERE display_flag = 1 AND member_id ='$following_id'ORDER BY id DESC LIMIT 100";
